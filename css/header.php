...
<header id="header">
    <div class="top__row">
        <div class="conteiner m-auto">
            <div class="logo">
                <a href="/">
                    <img src="<?php echo carbon_get_theme_option( 'kor_logo' ) ?>"
                         alt="Логотип Магазина 'Карзинка'">
                        </a>
            ...
            <a class="category__link" href="http://korzinka11.ru/shop/">Каталог</a>
            ...
            <div class="cabinet">
                <a href="/my-account/">
                    <img src="<?php echo get_template_directory_uri() ?>/assets/img/icon/noun_personal.png"
                         alt="personal icon">
        ...
        <div class="conteiner m-auto">
          ...
          <span class="burger__catalog">
            <span></span>
                ...
                <a class="category__link " href="/shop/">Каталог товаров</a>
                <div class="category">
